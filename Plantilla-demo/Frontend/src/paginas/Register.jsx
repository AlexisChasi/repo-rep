...
const handleSubmit = async(e) => { 
    ...
    return (
        <>
            <div className="text-[#C08261] flex justify-center items-center w-1/2">

                <div className="md:w-4/5 sm:w-full">
                {Object.keys(mensaje).length>0 && <Mensaje tipo={mensaje.tipo}>{mensaje.respuesta}</Mensaje>}
                    <h1 className="text-3xl font-semibold mb-2 text-center uppercase  text-[#C08261]">Bienvenido</h1>
                    <small className="text-gray-400 block my-4 text-sm">Igresa la informacion</small>
                    ...
                    <div className="mt-3 text-sm flex justify-between items-center">
                        ...
                        <Link to="/login" className="py-2 px-5 bg-[#9A3B3B] text-slate-300 border rounded-xl hover:scale-110 duration-300 hover:bg-gray-900 ">Iniciar sesion</Link>
                    </div>
